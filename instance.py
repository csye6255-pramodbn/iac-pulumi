...
from variables import num_instances, instance_type, ebs_size, ebs_type, delete_on_termination, accidental_termination, ami_id, associate_public_ip, instance_name, keypair_name
